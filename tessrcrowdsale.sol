...
// --- (c) tessr.network / tessr.io 2018. The MIT License.
// ----------------------------------------------------------------------------
...
contract TessrCrowdSale {
    using SafeMath for uint256;

    /// NAC Broker Presale Token
    /// @dev Constructor
    function TessrCrowdSale(address _escrow, address _namiMultiSigWallet, address _namiPresale) public {
...
contract BinaryOption {
     ...
     */
    // TessrCrowdSale address
    address public TessrCrowdSaleAddr;
    address public escrow;
    ...
    function BinaryOption(address _TessrCrowdSale, address _escrow, address _namiMultiSigWallet) public {
        require(_TessrCrowdSale != 0x0 && _escrow != 0x0);
        TessrCrowdSaleAddr = _TessrCrowdSale;
        escrow = _escrow;
        namiMultiSigWallet = _namiMultiSigWallet;
    }
        ...
        onlyEscrow
    {
        ...
        uint etherToBuy;
        TessrCrowdSale namiContract = TessrCrowdSale(TessrCrowdSaleAddr);
